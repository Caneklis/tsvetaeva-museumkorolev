...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document
    ...
    <path d="M15 2V28" stroke="#5896A3" stroke-width="3" stroke-linecap="square" stroke-linejoin="round"/>
    <path d="M2 15L28 15" stroke="#5896A3" stroke-width="3" stroke-linecap="square" stroke-linejoin="round"/>
    </svg>`
    );
  document
    ...
    <path d="M2 2L28 2" stroke="#5896A3" stroke-width="3" stroke-linecap="square" stroke-linejoin="round"/>
    </svg>
    `
    );
  ...
  searchFormBtn.addEventListener('click', () => {
    document
      ...
      .classList.toggle('poimapbox-sidebar--active');
